...
path1 = "C:/Users/HP/PycharmProjects/phonepe/pulse/data/aggregated/transaction/country/india/state/"
columns1 = {
    "State": [],
    "Year": [],
    "Quarter": [],
...
with open('Statenames.csv', mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['state'])
    for item in agg_trans_list:
...
path2 = "C:/Users/HP/PycharmProjects/phonepe/pulse/data/aggregated/user/country/india/state/"
...
path3 = "C:/Users/HP/PycharmProjects/phonepe/pulse/data/map/transaction/hover/country/india/state/"
...
path4 = "C:/Users/HP/PycharmProjects/phonepe/pulse/data/map/user/hover/country/india/state/"
...
path5 = "C:/Users/HP/PycharmProjects/phonepe/pulse/data/top/transaction/country/india/state/"
...
#print(df_top_trans.shape)

#Dataframe of top users

path6 = "C:/Users/HP/PycharmProjects/phonepe/pulse/data/top/user/country/india/state/"
...
df_agg_trans.to_csv('C:/Users/HP/PycharmProjects/phonepe/csv/agg_trans.csv',index=False)
df_agg_user.to_csv('C:/Users/HP/PycharmProjects/phonepe/csv/agg_user.csv',index=False)
df_map_trans.to_csv('C:/Users/HP/PycharmProjects/phonepe/csv/map_trans.csv',index=False)
df_map_user.to_csv('C:/Users/HP/PycharmProjects/phonepe/csv/map_user.csv',index=False)
df_top_trans.to_csv('C:/Users/HP/PycharmProjects/phonepe/csv/top_trans.csv',index=False)
df_top_user.to_csv('C:/Users/HP/PycharmProjects/phonepe/csv/top_user.csv',index=False)
