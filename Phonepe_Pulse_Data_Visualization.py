...
st.set_page_config(
    page_title="Phonepe Pulse Data Visualization | By Dhananjay Gothankar",
    page_icon=icon,
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={
        "About": """# This dashboard app is created by *Dhananjay Gothankar*!
...
mydb = sql.connect(
    host="localhost", user="root", password="12345", database="phonepe_pulse"
)
...
# MENU 1 - HOME
if selected == "Home":
    image1 = Image.open("C:/Users/HP/PycharmProjects/phonepe/img.png")
    st.image(image1)
    ...
    with col2:
        image2 = Image.open("C:/Users/HP/PycharmProjects/phonepe/home.png")
        st.image(image2)
...
if selected == "Top Charts":
    ...
    if Type == "Users":
        ...
        with col4:
            ...
            df = pd.DataFrame(
                mycursor.fetchall(), columns=["State", "Total_Users", "Total_Appopens"]
            )
            fig = px.pie(
                df,
                values="Total_Users",
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv("C:/Users/HP/PycharmProjects/phonepe/Statenames.csv")
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/ddg111088/phonepe_newproject")
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        image3 = Image.open("C:/Users/HP/PycharmProjects/phonepe/Pulseimg.jpg")
        st.image(image3)
